...
bool RoadLine::ReadRoadLine() {
  ...
  goal_pose_.position.x = prime_road_[740 / simple_segment].x;
  goal_pose_.position.y = prime_road_[740 / simple_segment].y;
  goal_pose_.orientation =
      tf::createQuaternionMsgFromYaw(prime_road_[740 / simple_segment].yaw);
