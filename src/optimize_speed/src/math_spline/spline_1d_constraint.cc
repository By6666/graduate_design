...
#include "math_spline/spline_1d_constraint.h"
...
bool Spline1dConstraint::AddConstraintInRange(AddConstraintInRangeFunc func, const double x,
...
bool Spline1dConstraint::AddPointConstraintInRange(const double x, const double fx,
                                                   const double range) {
...
bool Spline1dConstraint::AddPointDerivativeConstraintInRange(const double x, const double dfx,
                                                             const double range) {
